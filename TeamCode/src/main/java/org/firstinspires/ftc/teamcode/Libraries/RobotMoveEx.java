...
public class RobotMoveEx {
    ...
    public void runMotorsForDistance(double FRS, double FLS, double BRS, double BLS, double distance) {
        ...
        double dStartTicks = robot.motorFR.getCurrentPosition();
        ...
        double dTicks = Math.abs(robot.motorFR.getCurrentPosition() - dStartTicks);
        ...
        while (dTicks < distance) {
            ...
            dTicks = Math.abs(robot.motorFR.getCurrentPosition() - dStartTicks);
        }
