...
public class ControllerTest extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            /*
            since each section is functionally identical, I will only explain one.

            sets the string to display four defined parameters that we then set to the appropriate
            controller input
             */
            ...
            sStartBack = String.format(Locale.US, "start(%d), back(%d)",
                    gamepad1.start ? 1 : 0,
                    gamepad1.back ? 1 : 0);
            ...
            //update all our lines on the driver hub screen
            telemetry.update();
        }
    }
}
