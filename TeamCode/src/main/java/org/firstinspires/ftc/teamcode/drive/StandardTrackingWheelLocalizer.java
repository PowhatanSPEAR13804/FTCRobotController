...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double X_MULTIPLIER = 72/22.9450;
    public static double Y_MULTIPLIER = -72/22.8957;
    ...
    public StandardTrackingWheelLocalizer(HardwareMap hardwareMap) {
        ...
        leftEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "Hub2_Motor3"));
        rightEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "Hub1_Motor2"));
        frontEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "Hub1_Motor0"));
