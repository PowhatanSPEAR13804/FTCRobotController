...
@Disabled
@Autonomous(name = "SPEAR Autonomous BLUE", group = "Examples")*/
public class SPEARAutonomousBlue /*extends OpMode */{
    /*
        ...
        private final Pose startPose = new Pose(0, 144, Math.toRadians(135)); // Start Pose of our robot.
        private final Pose scorePose = new Pose(12, 132, Math.toRadians(135)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
