...
public class SimplifiedOdometryRobot {
    ...
    private final double ODOM_INCHES_PER_COUNT   = (2*24/25.4*Math.PI)/2000;   //  GoBilda Odometry Pod (1/226.8)
    ...
    public void initialize(boolean showTelemetry)
    {
        ...
        leftFrontDrive  = setupDriveMotor("Hub1_Motor3", DcMotor.Direction.FORWARD);
        rightFrontDrive = setupDriveMotor("Hub2_Motor0", DcMotor.Direction.REVERSE);
        leftBackDrive  = setupDriveMotor( "Hub1_Motor0", DcMotor.Direction.FORWARD);
        rightBackDrive = setupDriveMotor( "Hub2_Motor3",DcMotor.Direction.REVERSE);
        //imu = myOpMode.hardwareMap.get(IMU.class, "imu");

        //  Connect to the encoder channels using the name of that channel.
        driveEncoder = myOpMode.hardwareMap.get(DcMotor.class, "Hub2_Motor2");
        strafeEncoder = myOpMode.hardwareMap.get(DcMotor.class, "Hub2_Motor1");
