...
public class PIDFlywheel extends NextFTCOpMode {
    private static final Logger log = LoggerFactory.getLogger(PIDFlywheel.class);
    ...
    public double PIDController(double goal) {
        ...
        lastError = error;
        timer.reset();
        double outputPower = -(kP * error) + (kI * integralSum) + (kD * derivative);
        telemetry.addData("goal: ", goal);
        telemetry.addData("flywheel speed: ", flywheelVelocity);
        telemetry.addData("error: ", error);
        telemetry.addData("derivative: ", derivative);
        telemetry.addData("integral sum: ", integralSum);
        telemetry.addData("out: ", outputPower);
        telemetry.update();
        return outputPower;
    }
}