...
public final class LogFiles {
    ...
    public static class LogFile {
        ...
        public double mecTransP = MecanumOdometry.TRANSLATIONAL_PID.kP;
        public double mecTransI = MecanumOdometry.TRANSLATIONAL_PID.kI;
        public double mecTransD = MecanumOdometry.TRANSLATIONAL_PID.kD;
        public double mecHeadingP = MecanumOdometry.HEADING_PID.kP;
        public double mecHeadingI = MecanumOdometry.HEADING_PID.kI;
        public double mecHeadingD = MecanumOdometry.HEADING_PID.kD;
        public double mecLateralMultiplier = MecanumOdometry.LATERAL_MULTIPLIER;
